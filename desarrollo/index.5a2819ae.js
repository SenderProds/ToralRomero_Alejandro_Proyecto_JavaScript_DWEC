 ...
 */ function eventoProducto() {
    ...
    if (productosContainer.firstChild.tagName == "UL") {
        let liProductos = productosContainer.querySelector("ul").querySelectorAll("li");
        ...
        let trProductos = productosContainer.querySelector("table").querySelector("tbody").querySelectorAll("tr");
...
async function detalleProducto(id) {
    ...
    if (document.getElementById("detalle")) contenido.removeChild(document.getElementById("detalle"));
 ...
 */ function cargarProductos() {
    ...
    if (document.getElementById("carrito")) contenido.removeChild(carrito);
    if (document.getElementById("detalle")) contenido.removeChild(document.getElementById("detalle"));
    if (!categoria) {
        if (btnTabla.classList.contains("seleccionado")) {
            if (ordenar == "asc") crearTablaProductos(obternerProductosAscendente());
            else if (ordenar == "desc") crearTablaProductos(obtenerProductosDescendente());
            else crearTablaProductos(obtenerProductos());
        } else {
            if (ordenar == "asc") generarListaProductos(obternerProductosAscendente());
            else if (ordenar == "desc") generarListaProductos(obtenerProductosDescendente());
            else generarListaProductos(obtenerProductos());
        }
    } else generarListaProductos(obtenetProductosCategoria(categoria));
...
//# sourceMappingURL=index.5a2819ae.js.map
