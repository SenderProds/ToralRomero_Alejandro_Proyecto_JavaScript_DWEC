...
function resetearContenido() {
    if (!productosContenedor.classList.contains("ocultar")) productosContenedor.classList.add("ocultar");
    ...
    if (!document.getElementById("inicioSesion").classList.contains("ocultar")) document.getElementById("inicioSesion").classList.add("ocultar");
    if (!document.getElementById("registro").classList.contains("ocultar")) document.getElementById("registro").classList.add("ocultar");
    if (!document.getElementById("contacto").classList.contains("ocultar")) document.getElementById("contacto").classList.add("ocultar");
}

//# sourceMappingURL=index.6d01d101.js.map
