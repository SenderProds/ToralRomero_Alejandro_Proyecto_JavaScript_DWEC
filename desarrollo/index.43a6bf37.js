...
btnAscendente.addEventListener("click", (e)=>{
    if (contenido.dataset.ordenar == "desc") btnDescendente.classList.remove("seleccionado");
    contenido.dataset.ordenar = "asc";
    btnAscendente.classList.toggle("seleccionado");
    cargarProductos();
});
btnDescendente.addEventListener("click", (e)=>{
    if (contenido.dataset.ordenar == "asc") btnAscendente.classList.remove("seleccionado");
